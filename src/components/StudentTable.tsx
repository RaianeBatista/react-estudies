      ...
      <tbody>
        {students.map((people) => (
          ...
          >
            ...
            <td className="p-3">
              {people.active && (
                <div className='p-2 py-1 inline-block rounded-md border border-green-800 bg-green-600 text-white text-xs'>
                  Active
                </div>
              )}
              {!people.active && (
                <div className='p-2 py-1 inline-block rounded-md border border-red-800 bg-red-600 text-white text-xs'>
                  Inactive
                </div>
              )}
            </td>
